jQuery(document).ready(function ($) {
    ...
    function filterSelect() {
        ...
        filters["author"] = hashFilter["author"];
        ...
        if ( currentFilter == hashFilter["subject"] || currentFilter == hashFilter["author"] ) {
        ...
        // Create new hash
        var newHash = "subject=" + encodeURIComponent( filters["subject"] ) + "&author=" + encodeURIComponent( filters["author"] );
    ...
    function onHashChange() {
        ...
        var theFilter = hashFilter["subject"] + hashFilter["author"];
    ...
    function getHashFilter() {
        ...
        var author = location.hash.match( /author=([^&]+)/i );
        ...
        hashFilter["author"] = author ? author[1] : "*";
